...
{
    public function get_all_by_date_range(Request $request) {
        $data = [];
        $type = $request->type;
            ...
            if(($created_at >= $startDate) && ($created_at <= $endDate)) {
                ...
                if($stocksData !== null) {
                    ...
                    foreach ($stocksData as $stock) {
                        if((Carbon::parse($stock->created_at)->format('d/m/Y') >= $startDate) && (Carbon::parse($stock->created_at)->format('d/m/Y') <= $endDate)) {
                            $stocks[] = [
